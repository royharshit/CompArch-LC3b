...
int GetISR_ADDRMUX(int *x)   { return((x[ISR_ADDRMUX1] << 1) + x[ISR_ADDRMUX0]); }
...
void eval_micro_sequencer() {
   ...
   */
    ...
    uint8_t b = (CURRENT_LATCHES.MAR < 0x3000)? 1:0;
    uint8_t c = ((((CURRENT_LATCHES.IR&0xF000) >> 12) == 6) || (((CURRENT_LATCHES.IR&0xF000) >> 12) == 7))? 1: 0;
    uint8_t mar_0 = CURRENT_LATCHES.MAR & 0x0001;
    uint16_t psr15 = ((CURRENT_LATCHES.PSR & 0x8000) >> 15);
    uint8_t interupt = CURRENT_LATCHES.INTV & 0x0001;
 
    NEXT_LATCHES.STATE_NUMBER = ird ? ird1 ? (48+opcode1):  opcode: \
        (((CURRENT_LATCHES.MICROINSTRUCTION[J5] & 0b1) | ((c == 1) & (mar_0 == 1) & (cond2 == 1) & (cond1 == 1) & (cond0 == 0))) << 5) + \
        (((CURRENT_LATCHES.MICROINSTRUCTION[J4] & 0b1) | ((b == 1) & (psr15 == 1) & (cond2 == 1) & (cond1 == 0) & (cond0 == 1))) << 4) + \
        ...
        (((CURRENT_LATCHES.MICROINSTRUCTION[J0] & 0b1) | ((ir_11 == 1) & (cond2 == 0) & (cond1 == 1) & (cond0 == 1))));
...
void latch_datapath_values() {
  ...
  if (ld_mar == 1) {
    NEXT_LATCHES.MAR = (CURRENT_LATCHES.MICROINSTRUCTION[MARMUX2] == 0)? Low16bits(BUS): Low16bits(CURRENT_LATCHES.ISR_ADDR);
  }
